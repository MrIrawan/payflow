        ...
        <>
            {employeeData.map((data, index) => (
                <DropdownMenu key={index}>
                        ...
                        <Card className="w-full h-14 p-2 shadow-none transition-all hover:bg-gray-100/50 cursor-pointer">
                            <div className="w-full h-full flex flex-row items-center justify-start gap-2">
                                <Avatar className="w-[15%] h-full rounded-full">
                                    <AvatarFallback className={`h-full rounded-full font-semibold text-white text-sm ${data.gender === "male" ? "bg-blue-500" : "bg-pink-500"}`}>{data.full_name.slice(0, 2)}</AvatarFallback>
                                    <AvatarImage />
                                </Avatar>
                    ...
                    <DropdownMenuContent side="left" align="start" className="w-96 h-96 p-4 flex flex-col gap-2">
                        <div className="w-full h-2/6">
                            <Avatar className="h-full w-2/6">
                                <AvatarFallback className={`h-full font-semibold text-3xl text-white ${data.gender === "male" ? "bg-blue-500" : "bg-pink-500"}`}>{data.full_name.slice(0, 2)}</AvatarFallback>
                            </Avatar>
                        </div>
                        ...
                        <div className="w-full flex flex-col gap-4">
                            <div className="flex flex-row items-center justify-start gap-2">
                                ...
                                <div className="flex flex-col gap-0">
                                    ...
                                    <CardDescription className="text-xs font-medium">{data.company_id}</CardDescription>
                                </div>
                            </div>
                            <div className="flex flex-row items-center justify-start gap-2">
                        ...
                        <div className="w-full">
                            <Button className="bg-blue-500 hover:bg-blue-700 [&_svg:not([class*='size-'])]:size-5">
